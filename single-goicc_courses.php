        ...
        <div class="bg-dark text-light border-top border-gray-900">
            <div class="container-xl">
                <div class="position-relative">
                    ...
                    <div class="course-featured bg-img bg-cover lazy" data-videobg data-ratio="56.25" data-src="<?php if ($post_thumbnail = get_the_post_thumbnail_url(get_the_ID(), 'large')) {
                                                                                                                    echo $post_thumbnail;
                                                                                                                } ?>">
                        <?php if ($featured_video_id) { ?>
                            <iframe src="https://player.vimeo.com/video/<?php echo $featured_video_id; ?>?background=1&autoplay=1&loop=1&autopause=0&byline=0&title=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay; fullscreen"></iframe>
                        <?php } ?>
                    </div>
                </div>
            </div>
                ...
                <?php if ($active_subscription) { ?>
                    <?php if ($connected_videolessons->have_posts()) { ?>
                        <section class="videolessons-list my-5">
                            <?php $i = 0;
                            while ($connected_videolessons->have_posts()) {
                                $connected_videolessons->the_post();
