<form method="post" id="adduser" action="<?php echo home_url().$_SERVER['REQUEST_URI']; ?>">
    <p class="form-username">
        <label for="username"><?php _e('User name', 'goicc'); ?></label>
    ...
    <p class="form-email">
        <label for="email"><?php _e('Email *', 'goicc'); ?></label>
    ...
    <p class="form-password">
        <label for="current_password"><?php _e('Current Password', 'goicc'); ?> </label>
    ...
    <p class="form-password">
        <label for="pass1"><?php _e('New Password', 'goicc'); ?> </label>
        <input class="text-input form-control" name="pass1" type="password" id="pass1" />
        <small class="form-text text-muted"><?php _e('Leave blank to leave unchanged', 'goicc'); ?></small>
    </p><!-- .form-password -->
    <p class="form-password">
        <label for="pass2"><?php _e('Repeat New Password', 'goicc'); ?> </label>
