            ...
            <div class="bg-gray-900 text-light border-top border-gray-900">
                <div class="container-xl">
                    ...
                    <div id="video-box" class="mx-nrow mx-md-0">
                        <div class="bg-img bg-cover lazy" data-src="<?php if ($post_thumbnail = get_the_post_thumbnail_url(get_the_ID(), 'large')) {
                                                                        echo $post_thumbnail;
                                                                    } ?>">
                                            ...
                                            <div class="row">
                                                <?php foreach ($references as $reference) { ?>
                                                    <div class="col-6 col-md-4 col-xl-3 my-row">
                                                        <a href="<?php echo $reference['url']; ?>" data-caption="<?php echo $reference['caption']; ?>" alt="<?php echo $reference['alt']; ?>" data-fancybox="chapter-references" data-width="<?php echo $reference['width']; ?>" data-height="<?php echo $reference['height']; ?>" data-thumb="<?php echo $reference['sizes']['thumbnail']; ?>" data-src="<?php echo $reference['sizes']['thumbnail']; ?>" class="bg-img bg-cover p-ar-1x1 lazy">
                                                        </a>
                                                    </div>
                                                <?php } ?>
                                            </div>
                            ...
                            <?php if ($videos) { ?>
                                <div class="nav videolessons-videos d-block" id="videolessons-videos">
                                    <?php foreach ($videos as $index => $video) {
                                        ...
                                        <div data-toggle="tab" data-target="#video-<?php echo $tab_nr; ?>" data-index="<?php echo $tab_nr; ?>" data-id="<?php echo $video["goicc_videolessons_videos_id"]; ?>" data-title="<?php echo $video_title /* $video["goicc_videolessons_videos_title"]*/; ?>" class="element row no-gutters border-bottom border-left border-right <?php if ($index === 0) {
                                                                                                                                                                                                                                                                                                                                                                                echo 'border-top';
                                                                                                                                                                                                                                                                                                                                                                            } ?>">
                                            <div class="col-3 p-2">
                                                <div class="bg-img p-ar-3x2 bg-cover lazy thumbnail" data-src="<?php echo $video_thumb; ?>" <?php /*data-src="https://img.youtube.com/vi/<?php echo $video["goicc_videolessons_videos_id"]; ?>/default.jpg" */ ?>>
                                                </div>
                                            </div>
                    ...
                    <?php if (count($related_videolessons) > 1) { ?>
                        ...
                        <div class="navigation row">
                            <div class="col-6 text-left prev">
                                <?php $prev_index = $current_index - 1;
                                if ($prev_id = $related_videolessons[$prev_index]) {
                                    echo chapters_navigation($current_index, $prev_id, true);
                                } ?>
                            </div>
                            <div class="col-6 text-right next">
                                <?php $next_index = $current_index + 1;
                                if ($next_id = $related_videolessons[$next_index]) {
