...
<form role="search" method="get" class="search-form form-inline my-2 my-lg-0"
    ...
    <label for="<?php echo $unique_id; ?>">
        <span class="sr-only"><?php echo _x( 'Search for:', 'label', 'goicc' ); ?></span>
    </label>
    <input type="search" id="<?php echo $unique_id; ?>" class="search-field form-control mr-sm-2"
        placeholder="<?php echo esc_attr_x( 'Search &hellip;', 'placeholder', 'goicc' ); ?>"
    ...
    <button type="submit" class="search-submit btn btn-outline-success my-2 my-sm-0">
        <span class="sr-only"><?php echo _x( 'Search', 'submit button', 'goicc' ); ?></span>
        <span><?php echo _x( 'Search', 'submit button', 'goicc' ); ?></span>
    </button>
</form>