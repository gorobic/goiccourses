...
<?php } else { ?>
    ...
    <h1>
        ...
        if ($user_account_tabs) {
            echo $user_account_tabs[$current_tab];
        } ?>
    </h1>
            ...
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                    <div id="post-<?php the_ID(); ?>">
                        <div class="entry-content entry">
                            ...
                            <?php if (isset($update_user_result) && count($update_user_result['error']) > 0) { ?>
                                <div class="alert alert-danger" role="alert">
                                    <?php echo implode("<br />", $update_user_result['error']); ?>
                                </div>
                            <?php } elseif (isset($update_user_result) && $update_user_result['success']) { ?>
