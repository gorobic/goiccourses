...
<?php if (have_posts()) {
    while (have_posts()) {
        ...
        <div class="front-jumbo position-relative bg-dark text-light">
            <div class="front-jumbo__bg bg-img bg-cover lazy" data-videobg data-ratio="56.25" data-src="<?php if ($post_thumbnail = get_the_post_thumbnail_url(get_the_ID(), 'large')) {
                                                                                                            echo $post_thumbnail;
                                                                                                        } ?>">
                <iframe src="https://player.vimeo.com/video/625541855?background=1&autoplay=1&loop=1&autopause=0&byline=0&title=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay; fullscreen"></iframe>
            </div>
        ...
        <div class="container-xl mt-5 mt-lg-6 mb-4 mb-lg-5">
            <div class="row">
        ...
        <div class="container-xl mb-5 mb-lg-6">
        ...
        <div class="container-xl mb-5 mb-lg-6" id="faq">
            <h4 class="text-center mb-4 mb-lg-5">
                F.A.Q.
            </h4>
        ...
        <div class="container-xl mb-5 mb-lg-6" id="about">
            <h4 class="text-center mb-4 mb-lg-5">
